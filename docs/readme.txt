- Author: EdwinRodger (https://github.com/EdwinRodger/)
- Source: https://github.com/EdwinRodger/MyMangaDataBase
- License: GNU General Public License v3.0 (https://github.com/EdwinRodger/MyMangaDataBase/blob/main/LICENSE)

Instructions -
To run MyMangaDataBase, simply run `app_runner.py` file and it will do the rest
